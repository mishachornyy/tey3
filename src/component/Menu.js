...
const navigation = [
  ...
  { name: 'License', href: '#', current: false },
            ...
            <div className="relative flex h-[100px] items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start logo">
                ...
                <div className="hidden ml-[465px] sm:block">
                  <div className="flex space-x-4 head-info h-[99px] ">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className={classNames(
                          item.current ? ' text-white mt-[34px] ' : 'text-white mt-[34px]  ml-[60px]',
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? ' text-white head-info' : 'text-white head-info ',
